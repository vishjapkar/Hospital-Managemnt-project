    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
            <b>
                <img src="resources/images/phonee.png" style="width:27px;" alt="img">+91 9359786169 / +917058121907<br>
                <img src="resources/images/emaill.png" style="width:29px;" alt="img">japkarvishal97@gmail.com/
            </b>
        </p>
        </div>
      </div>
